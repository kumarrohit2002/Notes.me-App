...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isLogin) {
            ...
            await axios.post("http://localhost:4000/api/v1/user/login", userData)
                .then((res) => {
                    ...
                    toast.error(`Login failed, Error: ${error.message}`, { position: "top-center" });
                });

        } else {
            console.log("Signing up with", userData);
            await axios.post("http://localhost:4000/api/v1/user/signup", userData)
                .then((res) => {
                    console.log(res.data);
                    if (res.data) {
                    ...
                    console.log(error.message);
                    toast.error(`Signup failed, Error: ${error.message}`, { position: "top-center" });
                });
            setIsLogin(true);
        }
    };
